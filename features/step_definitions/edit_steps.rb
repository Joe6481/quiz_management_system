...
Then("I see the correct answers") do
  expect(page).to have_css(".correct_answer", style: "green") # may be a bit janky
end
...
Then("I see the quiz") do
  ...
  expect(page).to have_content("Test Create Quiz 1")
  expect(page).to have_content("Test Create Quiz 2 Answer 3")
end
